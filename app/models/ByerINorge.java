...
//		norskeByer.add("--- Finnmark ---");
		...
		norskeByer.add("Kirkenes"); 
		norskeByer.add("Vadsø");
		norskeByer.add("Vardø");
...
//		norskeByer.add("--- Nordland ---");
		...
		norskeByer.add("Leknes");
		norskeByer.add("Mo i Rana");
		norskeByer.add("Mosjøen");
		norskeByer.add("Narvik");
		norskeByer.add("Sandnessjøen");
		norskeByer.add("Sortland");
		norskeByer.add("Stokmarknes");
		norskeByer.add("Svolvær");
...
//		norskeByer.add("--- Nord-Trøndelag ---");
		...
		norskeByer.add("Steinkjer");
		norskeByer.add("Stjørdal");
		norskeByer.add("Verdalsøra");
...
//		norskeByer.add("--- Møre ogRomsdal ---");
		...
		norskeByer.add("Ulsteinvik");
		norskeByer.add("Ålesund");
		norskeByer.add("Åndalsnes");
...
//		norskeByer.add("--- Rogaland ---");
		...
		norskeByer.add("Jørpeland");
		norskeByer.add("Kopervik");
		norskeByer.add("Sandnes");
		norskeByer.add("Sauda");
		norskeByer.add("Skudeneshavn");
		norskeByer.add("Stavanger");
		norskeByer.add("Åkrehamn");
...
//		norskeByer.add("--- Vest-Agder ---");
		...
		norskeByer.add("Lyngdal");
		norskeByer.add("Mandal");
...
//		norskeByer.add("--- Aust-Agder ---");
		...
		norskeByer.add("Risør");
		norskeByer.add("Tvedestrand");
...
//		norskeByer.add("--- Telemark ---");
		...
		norskeByer.add("Notodden");
		norskeByer.add("Porsgrunn");
		norskeByer.add("Rjukan");
		norskeByer.add("Skien");
		norskeByer.add("Stathelle");
...
//		norskeByer.add("--- Hedmark ---");
		...
		norskeByer.add("Brumunddal");
		norskeByer.add("Moelv");
